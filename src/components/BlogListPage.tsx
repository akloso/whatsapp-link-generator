...
export default function BlogListPage({ onOpenPost }: Props) {
  return (
    <main className="bg-gradient-to-b from-white via-green-50/40 to-white pt-20 pb-14 sm:pt-24 sm:pb-16">
        ...
        <section className="grid gap-5 sm:grid-cols-2">
          {blogPosts.map((post) => (
            <a
              ...
              className="group block rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-500/25"
            ...
            >
              <article>
                ...
                <span className="mt-5 inline-flex rounded-xl bg-emerald-50 px-3 py-2 text-sm font-semibold text-emerald-800 transition group-hover:bg-emerald-100">
                  Read article
                </span>
              </article>
            </a>
