...
import { ArrowRight, ArrowUpRight, CalendarDays, Camera, Download, Headphones, Image as ImageIcon, Megaphone, Palette, ScanLine, ShoppingBag, Smile, Store, Trash2 } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-white py-8 sm:py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <section ref={editorRef} className="mb-6 rounded-[28px] border border-slate-200 bg-white px-5 py-5 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.18)] sm:mb-8 sm:px-7 sm:py-6">
        ...
        <section className="mt-16 rounded-[34px] border border-slate-200 bg-[#eef4ef] p-4 sm:p-6 lg:p-8">
              ...
              <div className="p-6 sm:p-9 lg:p-12">
                ...
                <div className="mt-7 space-y-3">
                  {[
                    ...
                    'Center emoji, icon, or uploaded logo',
                    'Export sizes: Square, Story, Poster',
                    'Always optimized for safe scanning',
                  ].map((item) => (
          ...
          <div className="mt-16">
            ...
            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <UseCaseCard icon={CalendarDays} title="Events" />
              <UseCaseCard icon={ImageIcon} title="Flyers & posters" />
              <UseCaseCard icon={Headphones} title="Customer support" />
              <UseCaseCard icon={Megaphone} title="Marketing campaigns" className="sm:col-span-2 lg:col-span-2" />
            </div>
          </div>
        </section>
