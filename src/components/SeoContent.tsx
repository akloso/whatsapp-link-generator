export default function SeoContent() {
  return (
    <section className="bg-gradient-to-b from-white to-cyan-50/50 py-12 sm:py-14">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <article className="liquid-glass-soft rounded-2xl p-5">
          ...
          <article className="liquid-glass-soft rounded-2xl p-5">
            ...
            <a
              href="/qr-code-editor"
              className="liquid-glass-button-light mt-3 inline-flex items-center rounded-xl px-3 py-1.5 text-xs font-semibold"
            >
