...
export default function Footer({ currentPage, onNavigate, onGetStarted }: FooterProps) {
  ...
  return (
    <footer className="relative border-t border-gray-200 bg-gradient-to-b from-gray-50 to-white py-12 text-gray-700 sm:py-14">
      <div className="absolute inset-0 opacity-60">
        <div className="absolute left-1/2 top-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-100 blur-3xl"></div>
      </div>
