...
export default function Footer({ currentPage, onNavigate, onGetStarted }: FooterProps) {
  ...
  return (
    <footer className="relative border-t border-gray-200 bg-gradient-to-b from-gray-50 to-white py-10 text-gray-700 sm:py-14">
      <div className="absolute inset-0 opacity-60">
        <div className="absolute left-1/2 top-1/2 h-56 w-56 -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-100 blur-3xl sm:h-80 sm:w-80"></div>
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="w-full border-t border-gray-200 pt-6 sm:pt-8">
