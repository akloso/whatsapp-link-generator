...
export default function Footer({ currentPage, onNavigate, onGetStarted }: FooterProps) {
  ...
  return (
    <footer className="relative border-t border-gray-200 bg-gradient-to-b from-gray-50 to-white py-7 text-slate-700 sm:py-9">
      <div className="absolute inset-0 opacity-60">
        <div className="absolute left-1/2 top-1/2 h-40 w-40 -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-100 blur-3xl sm:h-56 sm:w-56"></div>
      </div>
      ...
      <div className={pageShell}>
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mb-3 max-w-md text-sm leading-6 text-slate-600 sm:mb-5">
            Build a clean WhatsApp link in seconds with optional message text and a ready-to-share QR code.
          </p>

          <div className="w-full border-t border-gray-200 pt-4 sm:pt-5">
