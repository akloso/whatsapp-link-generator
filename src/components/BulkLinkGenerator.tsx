...
export default function BulkLinkGenerator() {
  ...
  return (
    <section className="zapora-warm-bg py-6 sm:py-8 lg:py-10">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <Surface className="relative bg-white/95 p-4 sm:p-5 lg:p-6">
          <SuccessConfetti active={showCelebration} />
          <div className="grid gap-5 lg:grid-cols-[minmax(0,0.92fr)_minmax(320px,1fr)] lg:gap-6">
            <div className="min-w-0 space-y-4 rounded-2xl bg-amber-50/40 p-3 sm:p-4">
