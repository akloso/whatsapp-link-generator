...
function HomeScreen({ navigate, onDataBackup, accountAction, collaboration }: { navigate: (view: View) => void; onDataBackup: () => void; accountAction?: ReactNode; collaboration?: SplitzapCollaboration }) {
...
function GroupScreen({ groupId, navigate, collaboration }: { groupId: string; navigate: (view: View) => void; collaboration?: SplitzapCollaboration }) {
  ...
  const mine = balances[memberIdFor(group, data)] ?? 0;
